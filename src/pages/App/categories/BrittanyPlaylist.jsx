    ...
    <div className="w-full flex flex-col justify-start items-start gap-4">
      ...
      <div className="w-full border rounded-2xl p-4 flex justify-start items-center gap-3">
        <div className="w-24 h-24 rounded-xl relative flex items-center justify-center">
          <span className="w-6 h-6 rounded-full flex items-center bg-white text-purple-600 cursor-pointer justify-center text-xs font-medium absolute top-2 right-2">
            <FaRegEdit />
          </span>
          <img
            src={playlist?.cover}
        ...
        <div className="w-auto flex flex-col gap-2 justify-start items-start">
          ...
          <button className="w-32 h-9 rounded-xl flex items-center justify-center text-md font-medium text-white bg-purple-600">
            Update
          </button>
        </div>
      </div>
