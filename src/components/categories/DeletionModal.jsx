...
const DeletionModal = ({ showModal, setShowModal, action, loading }) => {
  return showModal ? (
    <div className="w-screen h-screen z-[3000] fixed top-0 bottom-0 right-0 left-0 px-4 flex items-center justify-center bg-[rgba(0,0,0,0.5)] ">
      <div className="w-full lg:w-[430px] p-4 lg:px-6 lg:py-7 h-auto bg-white rounded-lg relative flex flex-col justify-between">
        <div className="w-full flex justify-between items-start">
          <div className="flex-col justify-center   text-center">
            ...
            <p className="pt-2">
              This will remove this post permanently from the database.
            </p>
